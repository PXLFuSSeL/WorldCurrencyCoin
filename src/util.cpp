...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\WCC
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\WCC
    // Mac: ~/Library/Application Support/WCC
    // Unix: ~/.WCC
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "WCC";
#else
    fs::path pathRet;
